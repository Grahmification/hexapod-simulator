...
namespace Hexapod_Simulator.Helix.Models.Old
{
    public class PlatformVisual3D : MeshElement3D
    {
        //public static readonly DependencyProperty TransformProperty =
            //DependencyProperty.Register("Transform", typeof(Transform3D), typeof(PlatformVisual3D), new UIPropertyMetadata(new TranslateTransform3D(0, 0, 0)));


        public static readonly DependencyProperty ZProperty =
            DependencyProperty.Register("Z", typeof(double), typeof(PlatformVisual3D), new UIPropertyMetadata(0.0));

        public IPlatform platformModel { get; set; } 

        public double Z { get { return platformModel.Position[2]; } set { 
                platformModel.TranslateAbs(new double[] { 0, 0, value });
                UpdateModel();              
            } }

              
        public PlatformVisual3D(IPlatform plat) : base()
        {
            platformModel = plat;
            UpdateModel();
        }
